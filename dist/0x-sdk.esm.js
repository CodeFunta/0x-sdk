...
var ROOT_STAGING_URL = 'https://staging.api.0x.org';
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              tx = erc20.approve(contractAddressToApprove, amount != null ? amount : MaxInt256, _extends({}, txOptions));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              return _context5.abrupt("return", MaxUint256);
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              _context7.next = 5;
              return signer.signMessage(arrayify(quote.orderHash));

            case 5:
              rawSignature = _context7.sent;
              _splitSignature = splitSignature(rawSignature), v = _splitSignature.v, r = _splitSignature.r, s = _splitSignature.s;
...
//# sourceMappingURL=0x-sdk.esm.js.map
