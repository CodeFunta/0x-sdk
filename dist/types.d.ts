...
export declare type ResourceType = 'swap' | 'rfqm';
...
export declare enum RfqmTransactionStates {
    Pending = "pending",
    Submitted = "submitted",
    Failed = "failed",
    Succeeded = "succeeded",
...
export declare type TransactionOverrides = Overrides & {
